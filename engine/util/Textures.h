...
// Level Browser
#define CONST_PATH_LB_BORDER "./res/textures/gui/level_browser.png"
#define CONST_PATH_SCROLL_BODY "./res/textures/gui/scroll_body.png"
...
#define CONST_PATH_BTN_SCROLL_HANDLE "./res/textures/gui/scroll_handle.png"
